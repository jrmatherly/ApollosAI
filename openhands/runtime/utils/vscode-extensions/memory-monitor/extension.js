...
function activate(context) {
  ...
  let startMonitorCommand = vscode.commands.registerCommand(
    "openhands-memory-monitor.startMemoryMonitor",
    function () {
      memoryMonitor.start();
    },
  );
  ...
  let stopMonitorCommand = vscode.commands.registerCommand(
    "openhands-memory-monitor.stopMemoryMonitor",
    function () {
      memoryMonitor.stop();
    },
  );
  ...
  let showMemoryDetailsCommand = vscode.commands.registerCommand(
    "openhands-memory-monitor.showMemoryDetails",
    function () {
