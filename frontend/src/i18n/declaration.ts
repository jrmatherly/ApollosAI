...
export enum I18nKey {
  ...
  MICROSOFT$SIGN_IN_WITH_MICROSOFT = "MICROSOFT$SIGN_IN_WITH_MICROSOFT",
  ...
  SETTINGS$PROVENANCE_ORG = "SETTINGS$PROVENANCE_ORG",
  SETTINGS$PROVENANCE_PERSONAL = "SETTINGS$PROVENANCE_PERSONAL",
  SETTINGS$PROVENANCE_TEAM = "SETTINGS$PROVENANCE_TEAM",
  ...
  ADMIN$ADD = "ADMIN$ADD",
  ADMIN$ADD_MCP_SERVER = "ADMIN$ADD_MCP_SERVER",
  ADMIN$ADDING = "ADMIN$ADDING",
  ADMIN$ALERTS_TITLE = "ADMIN$ALERTS_TITLE",
  ADMIN$API_KEYS_TITLE = "ADMIN$API_KEYS_TITLE",
  ADMIN$AUDIT_ACTION = "ADMIN$AUDIT_ACTION",
  ADMIN$AUDIT_ACTOR = "ADMIN$AUDIT_ACTOR",
  ADMIN$AUDIT_RESOURCE = "ADMIN$AUDIT_RESOURCE",
  ADMIN$AUDIT_TIMESTAMP = "ADMIN$AUDIT_TIMESTAMP",
  ADMIN$AUDIT_TITLE = "ADMIN$AUDIT_TITLE",
  ADMIN$AUTO_REFRESH = "ADMIN$AUTO_REFRESH",
  ADMIN$CONFIG_JSON = "ADMIN$CONFIG_JSON",
  ADMIN$CONFIGURE = "ADMIN$CONFIGURE",
  ADMIN$CONFIGURE_INTEGRATION = "ADMIN$CONFIGURE_INTEGRATION",
  ADMIN$DELETE = "ADMIN$DELETE",
  ADMIN$DISABLE = "ADMIN$DISABLE",
  ADMIN$ENABLE = "ADMIN$ENABLE",
  ADMIN$ENABLED = "ADMIN$ENABLED",
  ADMIN$FILTER_ACTION = "ADMIN$FILTER_ACTION",
  ADMIN$FILTER_ACTION_PLACEHOLDER = "ADMIN$FILTER_ACTION_PLACEHOLDER",
  ADMIN$INTEGRATIONS_TITLE = "ADMIN$INTEGRATIONS_TITLE",
  ADMIN$INVALID_JSON = "ADMIN$INVALID_JSON",
  ADMIN$INVITE = "ADMIN$INVITE",
  ADMIN$INVITE_MEMBER = "ADMIN$INVITE_MEMBER",
  ADMIN$INVITING = "ADMIN$INVITING",
  ADMIN$MCP_API_KEY = "ADMIN$MCP_API_KEY",
  ADMIN$MCP_ARGS = "ADMIN$MCP_ARGS",
  ADMIN$MCP_COMMAND = "ADMIN$MCP_COMMAND",
  ADMIN$MCP_DESCRIPTION = "ADMIN$MCP_DESCRIPTION",
  ADMIN$MCP_NAME = "ADMIN$MCP_NAME",
  ADMIN$MCP_NAME_PLACEHOLDER = "ADMIN$MCP_NAME_PLACEHOLDER",
  ADMIN$MCP_STATUS = "ADMIN$MCP_STATUS",
  ADMIN$MCP_TITLE = "ADMIN$MCP_TITLE",
  ADMIN$MCP_TYPE = "ADMIN$MCP_TYPE",
  ADMIN$MCP_URL = "ADMIN$MCP_URL",
  ADMIN$NAV_ALERTS = "ADMIN$NAV_ALERTS",
  ADMIN$NAV_API_KEYS = "ADMIN$NAV_API_KEYS",
  ADMIN$NAV_AUDIT = "ADMIN$NAV_AUDIT",
  ADMIN$NAV_INTEGRATIONS = "ADMIN$NAV_INTEGRATIONS",
  ADMIN$NAV_MCP = "ADMIN$NAV_MCP",
  ADMIN$NAV_MEMBERS = "ADMIN$NAV_MEMBERS",
  ADMIN$NAV_MODELS = "ADMIN$NAV_MODELS",
  ADMIN$NAV_TEAMS = "ADMIN$NAV_TEAMS",
  ADMIN$MEMBER_EMAIL = "ADMIN$MEMBER_EMAIL",
  ADMIN$MEMBER_ROLE = "ADMIN$MEMBER_ROLE",
  ADMIN$MEMBERS_TITLE = "ADMIN$MEMBERS_TITLE",
  ADMIN$MODELS_TITLE = "ADMIN$MODELS_TITLE",
  ADMIN$NEXT = "ADMIN$NEXT",
  ADMIN$NO_AUDIT_LOGS = "ADMIN$NO_AUDIT_LOGS",
  ADMIN$NO_INTEGRATIONS = "ADMIN$NO_INTEGRATIONS",
  ADMIN$NO_MCP_SERVERS = "ADMIN$NO_MCP_SERVERS",
  ADMIN$NO_MEMBERS = "ADMIN$NO_MEMBERS",
  ADMIN$NO_TEAMS = "ADMIN$NO_TEAMS",
  ADMIN$PAGE_INFO = "ADMIN$PAGE_INFO",
  ADMIN$PREV = "ADMIN$PREV",
  ADMIN$REMOVE = "ADMIN$REMOVE",
  ADMIN$ROWS_PER_PAGE = "ADMIN$ROWS_PER_PAGE",
  ADMIN$SAVING = "ADMIN$SAVING",
  ADMIN$STATUS_DISABLED = "ADMIN$STATUS_DISABLED",
  ADMIN$STATUS_ENABLED = "ADMIN$STATUS_ENABLED",
  ADMIN$TEAM_NAME = "ADMIN$TEAM_NAME",
  ADMIN$TEAMS_TITLE = "ADMIN$TEAMS_TITLE",
  ADMIN$TEST_CONNECTION = "ADMIN$TEST_CONNECTION",
  ADMIN$TEST_FAILED = "ADMIN$TEST_FAILED",
  ADMIN$TEST_SUCCESS = "ADMIN$TEST_SUCCESS",
  ADMIN$TESTING = "ADMIN$TESTING",
  ADMIN$TOTAL_ITEMS = "ADMIN$TOTAL_ITEMS",
  ADMIN$USER_ID = "ADMIN$USER_ID",
  ADMIN$USER_ID_PLACEHOLDER = "ADMIN$USER_ID_PLACEHOLDER",
}
