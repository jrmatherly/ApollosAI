...
class TestSettingsStoreLoad:
    ...
    @pytest.mark.asyncio
    async def test_load_returns_defaults_when_from_config_returns_none(
        self, monkeypatch
    ):
    ...
    @pytest.mark.asyncio
    async def test_load_with_session_returns_org_defaults(
    ...
    async def test_load_team_overrides_org(self, async_session, async_session_maker):
        ...
        org = Organization(
            id=uuid.uuid4(), name='test-org', default_llm_model='gpt-3.5'
        )
